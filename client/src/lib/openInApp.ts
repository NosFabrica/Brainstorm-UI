...
export type AppLinkId = "ditto" | "nostria" | "primal" | "amethyst" | "default";
...
export function appLinksFor(entity: OpenEntity, ua?: string): AppLink[] {
  ...
  if (isAndroid(ua)) links.push({ id: "amethyst", label: "Amethyst", href: amethystIntentUrl(entity.bech32), external: false });
  if (isPhoneOS(ua)) links.push({ id: "default", label: "Default app", href: entity.uri, external: false });
  return links;
}
