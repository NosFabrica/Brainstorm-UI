  ...
  return (
    <>
          ...
          <div className="flex items-center justify-center gap-4 my-8">
            ...
            />
            <motion.div 
              className="flex items-center gap-1 px-4 py-2 bg-slate-900/70 border border-brand-primary/20 rounded-full backdrop-blur-sm overflow-hidden"
              ...
              {['Σ', '→', 'α', '×', 'T(u)'].map((symbol, i) => (
                <motion.span 
                  ...
                  className={`text-[10px] font-mono ${
                    symbol === 'Σ' ? 'text-brand-primary' :
                    symbol === 'α' ? 'text-brand-accent' :
  ...
  return (
    <>
          ...
          <div className="relative flex items-center justify-center my-10">
            {/* Left nebula trail */}
            <div className="flex-1 h-px bg-gradient-to-r from-transparent via-brand-accent/20 to-brand-primary/[0.3]" />
            ...
            {/* Right nebula trail */}
            <div className="flex-1 h-px bg-gradient-to-r from-brand-primary/[0.3] via-brand-accent/20 to-transparent" />
          </div>
    </>
  );
}
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-center gap-3 my-10">
            ...
            <div className="w-1.5 h-1.5 rounded-full bg-brand-primary/[0.5]" />
            <div className="w-1 h-1 rounded-full bg-slate-600" />
          </div>
    </>
  );
