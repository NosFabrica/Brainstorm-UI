...
// The menu's "Get Priority" row reads the subscription; these tests are about
// accounts, so pin it to the free tier rather than standing up the session hook.
vi.mock("@/hooks/useSubscription", () => ({
  useSubscription: () => ({
    subscription: { tier: "free", status: "none", currentPeriodEnd: null, rail: null },
    tier: "free",
    status: "none",
