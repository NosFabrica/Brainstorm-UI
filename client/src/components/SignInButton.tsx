...
const VARIANT_CLASSES: Record<NonNullable<SignInButtonProps["variant"]>, string> = {
  primary:
    "inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-brand-primary hover:bg-brand-primary rounded-lg transition-colors active:scale-[0.98]",
  ghost:
