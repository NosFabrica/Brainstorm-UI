...
export default function NetworkPage() {
  ...
  const handleCopyNpub = async (npub: string, pubkey: string) => {
    try {
          ...
          {connectionPairs.map(([a, b], i) => {
            ...
            return (
              <line
                ...
                style={{
                  ["--dash" as string]: len,
                  animation: `networkLineDraw ${1.2 + (i % 3) * 0.4}s ease-out ${drawDelay}s forwards, networkLinePulse 12s ease-in-out ${drawDelay + 1.5}s infinite`,
