            ...
            <div className="flex items-center gap-4 sm:gap-6">
              ...
              <div className="hidden lg:flex gap-1" data-testid="row-nav-links">
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  className="gap-2 text-white bg-white/[0.12] rounded-md no-default-hover-elevate no-default-active-elevate"
                ...
                <TabsList className="mt-4 sm:mt-6 w-full grid grid-cols-2 h-auto p-0.5 sm:p-1 bg-slate-100/50 rounded-lg border border-slate-200/50" data-testid="tabs-search-mode">
                  ...
                  >
                    ...
                    <span className="inline-flex items-center gap-1 sm:gap-2">
                      ...
                      <span className="rounded-full bg-[#3730a3] text-white border border-[#3730a3]/40 px-1.5 sm:px-2 py-0.5 text-[9px] sm:text-xs font-bold tracking-wider uppercase shadow-sm">
                        Soon
                      </span>
                    </span>
                  </TabsTrigger>
