        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12 w-full">
          <div className="space-y-3 text-center max-w-3xl mx-auto animate-fade-up" data-testid="section-pricing-header">
            ...
            <p className="text-slate-600 font-medium text-lg max-w-2xl mx-auto" data-testid="text-pricing-subtitle">
              Every plan includes the full Brainstorm experience. Pick how often your trust graph recalculates.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <Button
                      variant="outline"
                      className="w-full bg-white hover:bg-[#3730a3] bg-none border border-[#3730a3]/20 hover:border-[#3730a3] text-[#3730a3] hover:text-white font-semibold tracking-wide shadow-sm hover:shadow-md transition-all"
